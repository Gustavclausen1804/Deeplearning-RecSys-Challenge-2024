...
DEFAULT_HISTORY_CATEGORY_COL = f"{DEFAULT_CATEGORY_COL}_fixed"
DEFAULT_HISTORY_SENTIMENT_COL = f"{DEFAULT_SENTIMENT_SCORE_COL}_fixed"
DEFAULT_HISTORY_TOPICS_COL = f"{DEFAULT_TOPICS_COL}_fixed"
